...
- [ ] 4.1 Protocol-level MCP test: same node script as 3.5 but on Mac -- verify wrapper finds system Chrome and all 3 tools work
...
- [ ] 4.4 Run `install_chrome_for_mcp` on Mac -- verify it skips download and reports system Chrome will be used
